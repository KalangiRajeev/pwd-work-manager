...
import { AGREEMENT_REGISTER, BILLS, MB_RECORDS, OFFICES } from 'src/app/models/constants';
  ...
  constructor(private activatedRoute: ActivatedRoute,
    ...
    this.activatedRoute.params.subscribe(params => {
      ...
      if (this.billId) {
        ...
        const msmtDocRef = doc(this.firestore, `${AGREEMENT_REGISTER}/${this.agtRegId}/${BILLS}/${this.billId}`);
  ...
  async saveBill() {
    if (this.billFormGroup.valid && this.agtRegId) {
      const bill: Bill = {
        ...
        dateOfRecommendation: new Date(this.dateOfRecomendation.value).getTime(),
      ...
      if (this.billId) {
        ...
        const collectionAgreementRegister = collection(this.firestore, `${AGREEMENT_REGISTER}/${this.agtRegId}/${BILLS}`);
